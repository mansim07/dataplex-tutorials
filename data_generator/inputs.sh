...
customer_bq_table="customer_raw_data.customer_demographics"
cc_customer_map_bq_table="customer_raw_data.customer_credit_card_profile"
customer_seed=10
...
merchant_bq_table="merchant_raw_data.core_merchants"
mcc_bq_table="merchants_reference_data.mcc_code"


#Credit Card Transactions Inputs
credit_card_project=${PROJECT_ID}
credit_card_bucket="${PROJECT_ID}_trasactions_data"
...
auth_bq_table="transaction_raw_data.auth_table"